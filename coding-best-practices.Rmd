...
```python
# Python: create a code block with parenthesis to indent
output = (
...
> * Most programming languages have `map`, `filter`, `reduce`, `apply` ... they have been designed to write faster, maintainable and reproducible code.
